...
// "A" over a baseline — used for the Text Color button.
inline QIcon textColor(const QColor &c)
{
    return svgIcon(QStringLiteral(
        "<path d='M4 20h16'/>"
...
// Highlighter pen — used for the Highlight Color button.
inline QIcon highlight(const QColor &c)
{
    return svgIcon(QStringLiteral(
        "<path d='m9 11-6 6v3h9l3-3'/>"
        "<path d='m22 12-4.6 4.6a2 2 0 0 1-2.8 0l-5.2-5.2a2 2 0 0 1 0-2.8L14 4'/>"), c);
}
